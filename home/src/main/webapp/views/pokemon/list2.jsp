		...
		<form>
			<div class="flex-box" style="justify-content: center">
				<select name="column" class="form-input me-10">
					<option value="pokemon_name" <%=column!=null&&column.equals("pokemon_name") ? "selected" : ""%>>이름</option>
					<option value="pokemon_type" <%=column!=null&&column.equals("pokemon_type") ? "selected" : ""%>>속성</option>
				</select>	

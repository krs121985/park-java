...
<form action="./add.do" method="post" enctype="multipart/form-data" autocomplete="off" onsubmit="return checkForm();">
   ...
   <div class="container w-400">
       ...
       <div class="cell">
           ...
           <input type="text" name="bookTitle" class="form-input w-100" onblur="checkBookTitle();">
       ...
       <div class="cell">
           ...
           <!-- <input type="number" name="bookPageCount" class="form-input w-100"> -->
       ...
       <div class="cell">
        ...
        <div class="cell mt-40 right">
            <button type="button" class="form-btn">취소하기</button>
            <button type="submit" class="form-btn">등록하기</button>
        </div>
